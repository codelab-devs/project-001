...
class Program
{
    static async Task Main()
    {
        ...
        if (HandlePollingErrorAsync != null)
    ...
    private static Task HandlePollingErrorAsync(ITelegramBotClient botClient,Exception error,CancellationToken cancellationToken)
    {
